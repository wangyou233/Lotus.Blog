...
public class CustomViewService : BaseService<CustomView, IBaseDbRepository>, IDependency, ICustomViewService
{
    
    public CustomViewService(IBaseDbRepository repo) : base(repo)
    {
    }
}
