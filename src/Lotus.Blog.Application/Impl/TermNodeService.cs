...
public class TermNodeService : BaseService<TermNode, IBaseDbRepository>, IDependency, ITermNodeService
{
    
    public TermNodeService(IBaseDbRepository repo) : base(repo)
    {
    }
}